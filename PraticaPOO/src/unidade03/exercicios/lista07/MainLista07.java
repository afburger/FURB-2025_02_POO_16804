...
public class MainLista07 {
	public static void main(String[] args) {
		...
		AtendimentoEmergencia atendimentoEmergencia = new AtendimentoEmergencia(LocalDate.now(), "Asa quebrada", animal3, vet1);
		atendimentoEmergencia.setNivelUrgencia(1);
		animal3.adicionarAtendimento(atendimentoEmergencia);

		// c. Crie uma consulta de retorno para um dos animais, associada a uma das consultas comuns.
		AtendimentoRetorno atendimentoRetorno = new AtendimentoRetorno(LocalDate.now().plusDays(15), "Retorno para avaliação do tratamento", animal1, vet1);
		atendimentoRetorno.setAtendimentoAnterior(atendimento1);
		animal1.adicionarAtendimento(atendimentoRetorno);
